...
class CrystalCIF_v2(Dataset):
    ...
    def __getitem__(self, item_id):
        ...
        return self.names[item_id], self.radii[start:end], self.map_ab_p_to_a[start:end], self.map_ab_p_to_b[start:end], self.geometries[item_id], self.atomic_charges[item_id], self.lattice_params[item_id], properties
